...
``env HOME=__INSTALL_DIR__ CONFIG_PATH=__INSTALL_DIR__/.config DATABASE_PATH=__INSTALL_DIR__ "__INSTALL_DIR__"/venv/bin/garmin2fittrackee setup config-tool``
